...
UpdateMissingTranslation <- function(
                                     ...
                                     missingTranslationFile="missingTranslations.txt"){
    ...
    translationContent <- fromJSON(translationFile)
...
UpdateTranslation <- function(translationFile="translation.json",
                              translationBin="translation.bin"
                              ){
